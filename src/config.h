...
// MOTORS PIN
const uint8_t MOTOR_LEFT_DIR1 = 2;
const uint8_t MOTOR_LEFT_DIR2 = 3;
const uint8_t MOTOR_LEFT_PWM = 10;

const uint8_t MOTOR_RIGHT_DIR1 = 4;
const uint8_t MOTOR_RIGHT_DIR2 = 5;
const uint8_t MOTOR_RIGHT_PWM = 11;
